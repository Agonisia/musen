...
void CModelPPPopovJKR::CalculatePPGPU(double _time, double _timeStep, const SInteractProps _interactProps[], 
                                  const SGPUParticles& _particles, SGPUCollisions& _collisions)
{
	CUDA_KERNEL_ARGS2_DEFAULT(CUDA_CalcPPForce_PopovJKR_kernel,
		_timeStep,
		_interactProps,
...
__global__ void CUDA_CalcPPForce_PopovJKR_kernel(
	double                  _timeStep,
